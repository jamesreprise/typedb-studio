...
class GeometryTest {
    ...
    fun rayCircleIntersect1() {
        ...
        assertOffsetSetEquals(setOf(Offset(-1f, 0f), Offset(1f, 0f)), rayCircleIntersect(ray, circle))
    }
    ...
    fun rayCircleIntersect2() {
        ...
        assertOffsetSetEquals(setOf(Offset(-1f, 0f)), rayCircleIntersect(ray, circle))
    }
    ...
    fun rayCircleIntersect3() {
        ...
        assertOffsetSetEquals(setOf(Offset(2f, 0f), Offset(8f, 0f)), rayCircleIntersect(ray, circle))
    }
    ...
    fun rayCircleIntersect4() {
        ...
        val circle = Circle(x = 1f, y = 1f, r = 1f)
        assertOffsetSetEquals(setOf(Offset(0f, 1f), Offset(2f, 1f)), rayCircleIntersect(ray, circle))
    }
    ...
    private fun <T : Comparable<T>> assertSetEquals(
        ...
        assertTrue(message = "Expected $expected, actual $actual") {
            ...
            expectedSorted.forEachIndexed { idx, value ->
                if (!equalsFn(value, actualSorted[idx])) return@assertTrue false
            }

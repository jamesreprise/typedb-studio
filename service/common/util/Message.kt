    ...
    class Project(codeNumber: Int, messageBody: String) :
        ...
        companion object {
            ...
            val FAILED_TO_CREATE_DIRECTORY =
                Project(16, "Failed to create new directory at %s, due to:\n%s")
            val FAILED_TO_MOVE_DIRECTORY =
                Project(17, "Failed to move directory to %s, due to:\n%s")
            val FAILED_TO_RENAME_DIRECTORY =
                Project(18, "Failed to rename file to %s, due to:\n%s")
    ...
    class Schema(codeNumber: Int, messageBody: String) :
        ...
        companion object {
            ...
            val FAILED_TO_LOAD_TYPE =
                Schema(4, "Failed to load type properties, due to:\n%s")
            val FAILED_TO_DELETE_TYPE =
                Schema(5, "Failed to delete '%s' type, due to:\n%s")
            ...
            val FAILED_TO_CREATE_TYPE =
                Schema(7, "Failed to create %s type with label '%s', due to:\n%s")
            val FAILED_TO_RENAME_TYPE =
                Schema(8, "Failed to rename %s type '%s' to '%s', due to:\n%s")
            val FAILED_TO_CHANGE_SUPERTYPE =
                Schema(9, "Failed to change supertype of %s type '%s', due to:\n%s")
            val FAILED_TO_CHANGE_ABSTRACT =
                Schema(10, "Failed to change %s type to abstract / not abstract, due to:\n%s")
            val FAILED_TO_DEFINE_OWN_ATT_TYPE =
                Schema(11, "Failed to define %s type '%s' to own attribute type '%s', due to:\n%s")
            val FAILED_TO_UNDEFINE_OWNED_ATT_TYPE =
                Schema(12, "Failed to undefine %s type '%s' from owning attribute type '%s', due to:\n%s")
            val FAILED_TO_CHANGE_OVERRIDDEN_OWNED_ATT_TYPE =
                Schema(
                    13,
                    "Failed to change %s type '%s' owning attribute type '%s' to override attribute type '%s', due to:\n%s"
                )
            val FAILED_TO_CHANGE_OVERRIDDEN_OWNED_ATT_TYPE_TO_REMOVE =
                Schema(
                    14,
                    "Failed to change %s type '%s' owning attribute type '%s' to remove overridden attribute type, due to:\n%s"
                )
            val FAILED_TO_DEFINE_PLAY_ROLE_TYPE =
                Schema(15, "Failed to define %s type '%s' to play role type '%s', due to:\n%s")
            val FAILED_TO_UNDEFINE_PLAYED_ROLE_TYPE =
                Schema(16, "Failed to undefine %s type '%s' from playing role type '%s', due to:\n%s")
            val FAILED_TO_CHANGE_OVERRIDDEN_PLAYED_ROLE_TYPE =
                Schema(
                    17,
                    "Failed to change %s type '%s' playing role type '%s' to override role type '%s', due to:\n%s"
                )
            val FAILED_TO_CHANGE_OVERRIDDEN_PLAYED_ROLE_TYPE_TO_REMOVE =
                Schema(
                    18,
                    "Failed to change %s type '%s' playing role type '%s' to remove overridden role type, due to:\n%s"
                )
            val FAILED_TO_DEFINE_RELATES_ROLE_TYPE =
                Schema(19, "Failed to define relation type '%s' to relate role type '%s', due to:\n%s")
            val FAILED_TO_CHANGE_OVERRIDDEN_RELATED_ROLE_TYPE =
                Schema(
                    20,
                    "Failed to change relation type '%s' relating role type '%s' to override role type '%s', due to:\n%s"
                )
            val FAILED_TO_CHANGE_OVERRIDDEN_RELATED_ROLE_TYPE_TO_REMOVE =
                Schema(
                    21,
                    "Failed to change relation type '%s' relating role type '%s' to remove overridden role type, due to:\n%s"
                )
        }
    }
